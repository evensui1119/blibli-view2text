...
export const generate5W1HTool = tool(async ({ taskId, sectionIndex, }) => {
    ...
    name: "generate_5w1h",
    description: "为文章的指定章节生成 5W1H（Who/What/When/Where/Why/How）结构化总结。需要先通过 generate_article 生成文章后才能使用。",
    schema: z.object({
        taskId: z.string().describe("文章生成任务的 ID"),
        sectionIndex: z.number().describe("章节索引，从 0 开始"),
    }),
});
//# sourceMappingURL=generate-5w1h.js.map