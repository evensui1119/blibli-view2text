 ...
 * 从视频中提取帧图片（裁剪底部字幕区域）
 */
function extractFrames(videoPath, outputDir, fps = 0.5) {
 ...
 */
async function llmRecognizeFrames(framePaths, onProgress) {
 ...
 */
export async function llmExtractSubtitle(videoPath, onProgress) {
...
//# sourceMappingURL=llm-subtitle.js.map