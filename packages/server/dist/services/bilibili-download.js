 ...
 */
async function getPlayUrl(bvid, cid, cookie) {
 ...
 */
async function saveVideo(tmpPath, title, bvid) {
 ...
 */
export async function downloadBilibiliVideo(videoUrl, cookie) {
...
//# sourceMappingURL=bilibili-download.js.map